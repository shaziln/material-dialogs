...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        if (builder.backgroundCornerSize == 0) {
            builder.backgroundCornerSize = DialogUtils.resolveDimension(builder.context, R.attr.md_background_conner_size);
        }
        if (builder.backgroundColor != 0 && builder.backgroundCornerSize != 0) {
            GradientDrawable drawable = new GradientDrawable();
            drawable.setCornerRadius(builder.backgroundCornerSize);
